class Tfrr < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jimberlage/tfrr/releases/download/v0.2.0/tfrr-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/jimberlage/tfrr/releases/download/v0.2.0/tfrr-aarch64-linux.tar.gz"
      sha256 "59f8873fce701ca6cc576437de0452a0a62dff4479e22a7906cbae83e9e123d2"
    end
    on_intel do
      url "https://github.com/jimberlage/tfrr/releases/download/v0.2.0/tfrr-x86_64-linux.tar.gz"
